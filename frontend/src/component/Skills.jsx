  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <p className="text-gray-400 text-center mx-auto max-w-xl sm:max-w-2xl mb-10 sm:mb-12">
          Skills I am good at
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
          ...
          {skills &&
            skills.map((skill, index) => (
              <div
                key={index}
                className="bg-dark-300 border border-white/10 rounded-2xl p-5 sm:p-6 
              ...
              >
                ...
                <div className="flex items-center gap-3 sm:gap-4 mb-4">
                  <skill.icon className="w-8 h-8 sm:w-10 sm:h-10 text-purple" />
