            ...
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center space-x-10">
                    ...
                    <a
                        ...
                        className="px-4 py-2 border border-purple rounded-lg 
            ...
            <AnimatePresence>
                {showMenu && (
                    <motion.div
                        ...
                        className="md:hidden mt-4 bg-dark-300 rounded-xl p-6 flex flex-col space-y-6 text-center"
                    >
